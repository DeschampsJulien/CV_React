			...
			<div class="row row-cols-1 row-cols-md-3 g-4">
                <div class="col-lg-4 col-md-6">
					<div class="card h-100">
						...
						<a class="btn btn-primary" href="https://www.webcup.fr/boutique/je-cree-mon-premier-site-web-avec-html-css-ou-wordpress" target="_blank" rel="noreferrer" role="button">Lire la suite</a>
