			...
			<div class="row row-cols-1 row-cols-md-3 g-4">
                <div class="col-lg-4 col-md-6">
					<div class="card h-100">
						...
						<a class="btn btn-primary" href="https://www.webcup.fr/boutique/je-cree-mon-premier-site-web-avec-html-css-ou-wordpress" target="_blank" role="button">Lire la suite</a>
				...
				<div class="col-lg-4 col-md-6">
					<div class="card h-100">
						...
						<a class="btn btn-primary" href="https://lasagadesaudacieux.com/vente-de-produits" target="_blank" role="button">Lire la suite</a>
				...
				<div class="col-lg-4 col-md-6">
					<div class="card h-100">
						...
						<a class="btn btn-primary" href="https://falia.co/ressources/comment-etre-en-premiere-position-google" target="_blank" role="button">Lire la suite</a>
                        <div class="card-footer">
                            <small class="text-muted">Dernière mise à jour il y a 3 minutes</small>
                        </div>
					</div>
                ...
                <div class="col-lg-4 col-md-6">
					<div class="card h-100">
						...
						<a class="btn btn-primary" href="https://negliadesign.com/web/top-three-benefits-of-responsive-website-design" target="_blank" role="button">Lire la suite</a>
						<div class="card-footer">
							<small class="text-muted">Dernière mise à jour il y a 3 minutes</small>
						</div>
					</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="card h-100">
						...
						<a class="btn btn-primary" href="https://www.noiise.com/guide/seo" target="_blank" role="button">Lire la suite</a>
                        <div class="card-footer">
                            <small class="text-muted">Dernière mise à jour il y a 3 minutes</small>
                        </div>
					</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Le CPF permet à toute personne, salariée ou demandeur d’emploi, de suivre la formation de leur choix.</p>
                        </div>
						<a class="btn btn-primary" href="https://www.centre-europeen-formation.fr" target="_blank" role="button">Lire la suite</a>
                        <div class="card-footer">
                            <small class="text-muted">Dernière mise à jour il y a 3 minutes</small>
                        </div>
					</div>
